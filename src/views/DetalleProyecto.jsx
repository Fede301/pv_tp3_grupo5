...
const DetalleProyecto = () => {
    ...
    return (
        <Container className="mt-4 mb-5">
            <Card bg="dark" text="white" border="secondary" className="shadow">
                ...
                <Card.Body className="px-4">
                    ...
                    <div className="mb-4">
                        ...
                        <div className="ps-2">
                            <Button variant="outline-info" size="sm" className="px-4" href={recursos.pdf} target="_blank" rel="noreferrer">
                                📄 Ver Documento PDF
                            </Button>
                        </div>
                    </div>
                    ...
                    <div className="mb-4">
                        ...
                        <ListGroup variant="flush" className="rounded border border-secondary">
                            {equipo.map((persona, index) => (
                                <ListGroup.Item key={index} className="bg-dark text-white border-secondary d-flex justify-content-between align-items-center">
